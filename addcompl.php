		...
		<ul class="list-group" id="myinfo" >
			...
			<div class="panel panel-success">
					  	<div class="panel-heading">
					  		...
					  		<h3 class="panel-title">Case files</h3>
					  	</div>
				...
				<div class="container-fluid">
					<form class="form-horizontal" id="addcase"  role="form">
						...
						<div class="form-row">
                        	<div class="col-md-6">
					       		<div class="form-group">
					       		 <label for="">Victim ID:</label>
					       		 
					        		<input type="text" name="id" class="form-control" id="nid" placeholder="Enter ID"
					    		autofocus=""  >
					       		</div>
					...
					<div class="form-row">
                        <div class="col-md-6">
					  		...
					  		<div class="col-md-6">
					  	<div class="form-group">
									    <label for="">Crime Catagory:</label>
